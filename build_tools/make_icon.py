"""Render assets/icon.ico from assets/logo.png, or from the tray icon drawn in main.py if the logo is missing (run from repo root)."""
import sys
...
img = ns["create_tray_icon"]().convert("RGBA").resize((256, 256))
